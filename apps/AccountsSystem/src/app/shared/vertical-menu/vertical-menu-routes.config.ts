...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: '/settings', title: 'Users', icon: 'ft-users', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false, submenu: [
      {path: '/settings/users', title: 'Users List', icon: 'ft-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [],  Rights:[0,1]},
