...
export const ROUTES: RouteInfo[] = [
  ...
  //     { id: 215, path: '/sales/wholesale', title: 'Wholesale Invoice', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
  //   ],
  // },
  {
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 630, path: '/products/machines', title: 'Oil Machines', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
    ],
  }, {
    id: 700,
    ...
    submenu: [
      ...
      { id: 720, path: '/settings/userslist', title: 'Users List', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
