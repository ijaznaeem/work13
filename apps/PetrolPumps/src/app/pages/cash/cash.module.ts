...
import { CreditSaleVoucherComponent } from './creditsale-voucher/creditsale-voucher.component';
...
const routes:any = [
  ...
  { path: 'crdit-voucher', component: CreditSaleVoucherComponent, data: { breadcrumb: 'Credit Sale Voucher' } },
  { path: 'crdit-voucher/:EditID', component: CreditSaleVoucherComponent, data: { breadcrumb: 'Credit Sale Voucher' } },
