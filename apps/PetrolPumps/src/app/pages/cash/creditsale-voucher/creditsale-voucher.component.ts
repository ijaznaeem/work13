...
import { GetDateJSON, JSON2Date, RoundTo, getCurDate } from '../../../factories/utilities';
import { HttpBase } from '../../../services/httpbase.service';
import { MyToastService } from '../../../services/toaster.server';
import { VoucherModel } from '../voucher.model';

@Component({
  selector: 'app-creditsale-voucher',
  templateUrl: './creditsale-voucher.component.html',
  styleUrls: ['./creditsale-voucher.component.scss']
})
export class CreditSaleVoucherComponent implements OnInit {
  ...
  Round(amnt) {
    return RoundTo(amnt,2);
  }
  ChangeRate(v){
    console.log(v);
    this.Voucher.Debit = this.Voucher.Qty * v;

  }
  ChangeQty(v){
    console.log(v);

    this.Voucher.Debit = this.Voucher.Rate * v;
