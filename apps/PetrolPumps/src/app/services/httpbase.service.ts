...
export class HttpBase {
  ...
  getProducts(cat = 0) {
    let filter = ''
    if (cat != 0) {
      filter = 'filter=CategoryID =' + cat;
    }
    return this.getData('products?flds=ProductID,ProductName,SPrice,PPrice,Packing&' +
  ...
  openForm(form: any, formData: any = {}) {
    // this.openModal(ModalContainerComponent, { form: form, formdata: formData });
  ...
  openModal(Component, InitState: any = {}): BsModalRef {
