...
import { AdvanceTrForm } from './advance-paid.settings';

@Component({
  selector: 'app-advance-paid',
  templateUrl: './advance-paid.component.html',
  styleUrls: ['./advance-paid.component.scss'],
})
export class AdvancePaidComponent implements OnInit, OnChanges {
  @Input() Type: string;
  @Input() EditID = '';
