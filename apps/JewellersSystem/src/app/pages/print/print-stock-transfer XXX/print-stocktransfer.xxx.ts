...
@Component({
  selector: "app-print-stocktransfer",
  templateUrl: "./print-stocktransfer.component.html",
  styleUrls: ["./print-stocktransfer.component.scss"],
  changeDetection: ChangeDetectionStrategy.Default
})
export class PrintStockTransferComponent implements OnInit, AfterContentChecked {
  InvoiceID: any;
  Invoice: any = {
    Detail: [],
  };
  ...
  async SaveAsPdf() {
    let docDefinition = {
      ...
      footer: [
        {
          image: await this.getBase64ImageFromURL(this.IMAGE_URL + "brands.png"),
          width: 520,
          margin: [38, 0],
        },
        {
          image: await this.getBase64ImageFromURL(this.IMAGE_URL + "footer.png"),
          width: 520,
          margin: [38, 0],
        },
      ],
