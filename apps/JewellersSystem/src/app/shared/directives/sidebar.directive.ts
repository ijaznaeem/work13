import { AfterViewInit, ChangeDetectorRef, Directive, HostBinding, HostListener, Input, OnDestroy, OnInit } from '@angular/core';
...
export class SidebarDirective implements OnInit, AfterViewInit, OnDestroy {
  ...
  //close all other menu Products other than active one
