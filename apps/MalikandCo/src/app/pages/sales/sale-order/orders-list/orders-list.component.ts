...
import { SaleOrderComponent } from '../sale-order-add/sale-order.component';
import { OrdersListSetting } from './orders-list.settings';
...
export class OrdersListComponent implements OnInit {
  ...
  AddOrder(id = '') {
    ...
    this.bsModalRef = this.bsService.show(SaleOrderComponent, {
      initialState,
      class: 'modal-lg',
  ...
  Clicked(e) {
    ...
    if (e.action === 'print') {
      ...
      this.http
        .postTask('postorders-list/' + e.data.DetailID, {})
        .then((r: any) => {
          this.FilterData();
