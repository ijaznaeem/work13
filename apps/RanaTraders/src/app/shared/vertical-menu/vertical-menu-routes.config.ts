...
export const ROUTES: RouteInfo[] = [
  ...
  // },
  {
    ...
    submenu: [
      { id: 210, path: '/sales/wholesale/0', title: 'Wholesale Invoice', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      { id: 215, path: '/sales/retail/0', title: 'Retail Invoice', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
    ],
  },
  {
