export function AddDropDownFld(fldName, label, listTable, valueFld, displayFld, size, data:any= [], required= true) {
  return {
    fldName: fldName, control: 'select', type: 'dropdown', label: label,
