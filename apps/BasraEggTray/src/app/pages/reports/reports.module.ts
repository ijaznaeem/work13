...
const routes: any = [
  ...
  },
  {
    ...
    data: { breadcrumb: 'Sale Summary' },
  },
  {
    path: 'purchasesummary',
    component: PurchaseSummaryComponent,
    data: { breadcrumb: 'Purchase Summary' },
  },
  {
    path: 'salereport',
  ...
  {
    path: 'stocksm',
    component: StockSMComponent,
    data: { breadcrumb: 'Stock Salesman' },
  },
  ...
  },
  {
    ...
    data: { breadcrumb: 'Close Account' },
  },
  {
    path: 'recoverysheet',
    component: BillSummaryComponent,
    data: { breadcrumb: 'Recovery Sheet' },
  },
  {
    path: 'cashbook',
  ...
  {
    path: 'stockaccts',
    component: StockAcctsComponent,
    data: { breadcrumb: 'Stock Accts' },
  },
  {
    path: 'profit',
  ...
  {
    path: 'profitbybill',
    component: ProfitByBillComponent,
    data: { breadcrumb: 'Profit By Bill' },
  },
  {
    path: 'expreport',
    component: ExpReportComponent,
    data: { breadcrumb: 'Frenchiser Report' },
  },
  {
    path: 'sale-ledger',
    component: SaleLedgerComponent,
    data: { breadcrumb: 'Sale Ledger' },
  },
  {
    path: 'productionreport',
    component: ProductionReportComponent,
    data: { breadcrumb: 'Production Report' },
  },
];
@NgModule({
  declarations: [
