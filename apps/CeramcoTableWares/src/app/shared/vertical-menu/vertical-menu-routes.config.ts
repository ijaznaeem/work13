...
export const ROUTES: RouteInfo[] = [
  ...
  {
    id: 1100, path: '/production', title: 'Production', icon: 'ft-shopping-bag', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
    submenu: [
      { id: 1100, path: '/production/production', title: 'Production', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      { id: 1200, path: '/production/labour', title: 'Add Labour', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
    ],
  },
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 840, path: '/reports/labourreport', title: 'Labour Report', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 630, path: '/products/formulation', title: 'Products Formulation', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
    ...
    submenu: [
      ...
      { id: 730, path: '/settings/units', title: 'Units List', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
