...
import { BalanceSheetMonthlyComponent } from './balance-sheet-monthly/balance-sheet-monthly.component';
...
const routes:any= [
  ...
  { path: 'balancesheetmonthly', component: BalanceSheetMonthlyComponent, data: { breadcrumb: 'Sale Ledger' } },
