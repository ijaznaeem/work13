...
@Component({
  selector: 'app-invoice-cash',
  templateUrl: './invoice-cash.component.html',
  styleUrls: ['./invoice-cash.component.scss'],
})
export class InvoiceCashComponent implements OnInit, OnChanges {
  @Input() Type: string;
  @Input() EditID = '';
