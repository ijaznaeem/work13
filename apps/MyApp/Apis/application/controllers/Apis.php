...
class Apis extends REST_Controller
{
  ...
  public function profitreport_get($dte1, $dte2)
  {
    ...
    $query = $this->db->query("SELECT ProductName, Strength Sum(TotPcs) as QtySold, SUM(NetAmount) as Amount, SUM(Cost) as Cost, Sum(NetAmount-Cost) as Profit FROM qrysalereport WHERE Date BETWEEN '$dte1' AND '$dte2' GROUP BY  ProductName, Strength Order by ProductName ")->result_array();
    $this->response($query, REST_Controller::HTTP_OK);
  }
