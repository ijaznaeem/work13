...
import { Invoice, InvoiceDetails, TransferSettings } from './stock-transfer.settings';
...
export class StockTransferComponent implements OnInit, OnChanges {
  ...
  transferdetails:any = new InvoiceDetails();
  stocktransfer: any = new Invoice();
  ...
  public AddOrder() {
    ...
    this.transferdetails = new Invoice();
  }
  ...
  Cancel() {
    ...
    this.stocktransfer = new Invoice();
    this.stocktransfer.UserID = this.http.getUserID();
    this.transferdetails = new InvoiceDetails();
