...
export const ROUTES: RouteInfo[] = [
  ...
  // },
  {
    ...
    submenu: [
      ...
      { id: 215, path: '/sales/retail', title: 'Retail Invoice', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
    ],
  },
  {
  ...
  {
    id: 300, path: '/production', title: 'Production', icon: 'ft-shopping-bag', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
    submenu: [
      { id: 310, path: '/purchase/production-plan', title: 'Production Plan', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      { id: 315, path: '/purchase/production', title: 'Production Output', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      { id: 325, path: '/purchase/audit', title: 'Add Audit', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
...

  {
    ...
    submenu: [
      ...
      { id: 410, path: '/cash/recoverybybill', title: 'Recovery By Bill', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 825, path: '/reports/vouchers', title: 'Vouchers Report', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      ...
      { id: 845, path: '/reports/accum-expense', title: 'Total Payment Report', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      ...
      { id: 852, path: '/reports/audit', title: 'Audit Report', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      { id: 851, path: '/reports/productionreport', title: 'Production Report', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      { id: 852, path: '/reports/targetreport', title: 'Target Report', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      ...
      { id: 860, path: '/reports/recoverysheet', title: 'Recovery Sheet', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      ...
      { id: 865, path: '/reports/cashflow', title: 'Cash Flow Report', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      ...
      { id: 870, path: '/reports/raw-stock', title: 'Raw Stock Report', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      ...
      { id: 899, path: '/reports/shortstock', title: 'Short Stock Report', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
    ],
  },
  {
    id: 500,
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 620, path: '/products/rawitems', title: 'Raw Items', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
    ...
    submenu: [
      ...
      { id: 720, path: '/settings/stores', title: 'Manage Stores', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
