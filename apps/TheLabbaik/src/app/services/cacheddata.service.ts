...
export class CachedDataService {
  ...
  public apiroutes$ = this.http.get<any[]>(
  ...
  public apiStock$ = this.http.get<any[]>(
    this.api +
      'qrystock?filter=Stock>0&orderby=SortNo&bid=' +
  ...
  public apiSalesman$ = this.http.get<any[]>(
  ...
  public apiCompanies$ = this.http.get<any[]>(
    this.api + 'companies?bid=' + this.http2.getBusinessID()
  );
