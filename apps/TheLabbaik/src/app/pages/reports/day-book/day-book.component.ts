...
export class DayBookComponent implements OnInit {
  ...
  FilterData() {
    ...
    if (this.nWhat === '1') {
      ...
      table = 'production?orderby=ProductionID DESC';
    }
    ...
    if (e.action === 'delete') {
      ...
      if (e.data.IsPosted === '0') {
        ...
        this.http
          ...
          .catch((er) => {
            swal('Oops!', 'Error while posted data', 'error');
          });
      } else {
      ...
      swal({
        ...
        this.http
          ...
          .then((r: any) => {
            ...
            if (e.data.Type == '1') {
              this.router.navigateByUrl('/sales/invoice/' + r.id);
            } else {
              this.router.navigateByUrl('/sales/retail/' + r.id);
            }
          })
          .catch((er) => {
            swal('Oops!', 'Error while paying invoice', 'error');
