      ...
      foreach ($InvoiceRes as $InvoiceValue) {
        ...
        if ($InvoiceValue['DtCr'] == 'CR') {       // sale
          foreach ($InvoiceDetailsRes as $InvoiceDetailsvalue) {
            ...
            $this->UpdateAccount(
              $InvoiceValue['CustomerID'],
              $InvoiceValue['Date'],
              $InvoiceDetailsvalue['ProductName'],
              $InvoiceDetailsvalue['Amount'],0,
          ...
          if ($InvoiceValue['Discount'] > 0) {
            $this->UpdateAccount(
              $InvoiceValue['CustomerID'],
              $InvoiceValue['Date'],
              $data['Description'] = 'Discount Bill No ' . $InvoiceValue['InvoiceID'],
              0, $InvoiceValue['Discount'],
              $InvoiceValue['InvoiceID'],
              1,
              $InvoiceValue['BusinessID']
            );
          ...
          if ($InvoiceValue['AmountRecvd'] > 0) {
            $this->UpdateAccount(
              $InvoiceValue['CustomerID'],
              $InvoiceValue['Date'],
              $data['Description'] = 'Cach Received Bill No ' . $InvoiceValue['InvoiceID'],
              0, $InvoiceValue['AmountRecvd'],
              $InvoiceValue['InvoiceID'],
              1,
              $InvoiceValue['BusinessID']
            );
          ...
          foreach ($InvoiceDetailsRes as $InvoiceDetailsvalue) {
            $this->UpdateAccount(
              $InvoiceValue['CustomerID'],
              $InvoiceValue['Date'],
              $InvoiceDetailsvalue['ProductName'],0,
              $InvoiceDetailsvalue['Amount'],
              $InvoiceValue['InvoiceID'],
              1,
              $InvoiceValue['BusinessID'],
              $InvoiceDetailsvalue['Qty'],
          ...
          if ($InvoiceValue['Discount'] <> 0) {
            $this->UpdateAccount(
              $InvoiceValue['CustomerID'],
              $InvoiceValue['Date'],
              $data['Description'] = 'Discount Return Bill No ' . $InvoiceValue['InvoiceID'],
              $InvoiceValue['Discount'] * -1,0,
              $InvoiceValue['InvoiceID'],
              1,
              $InvoiceValue['BusinessID']
            );
