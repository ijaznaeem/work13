  ...
  implements OnInit, OnChanges, AfterViewInit
{
  ...
  private AddToDetails(ord: any) {
    const obj = {
      ...
      Amount:
      RoundTo((ord.PPrice * (ord.Qty * ord.Packing + ord.KGs * 1))/ord.RateUnit,2),
  ...
  StoreSelected(e) {
    if (e) {
      this.pdetails.StoreName = e.StoreName;
      this.http.getData('productbystore/' + e.StoreID).then((res1: any) => {
        this.Prods = [...res1];
      });
    }
  }
  RoundTo(value: number, dec:number = 2): number {
