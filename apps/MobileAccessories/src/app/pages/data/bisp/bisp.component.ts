...
export class BispComponent implements OnInit {
  ...
  FilterForm = {
    ...
    columns: [
      ...
      AddLookupFld('Zone', 'Select Zone', 'list/bisp/Zone', 'Zone', 'Zone', 2),
      AddLookupFld(
        'Mohallah',
        'Select Mohallah',
        'list/bisp/Zone',
      ...
      AddLookupFld('Status', 'Select Status', '', 'Status', 'Status', 2, [
        {
          Status: 'Active',
        },
        { Status: 'Applicant' },
  ...
  public form = {
    ...
    columns: [
      ...
      AddLookupFld('City', 'City/Village', 'list/bisp/City', 'City', 'City', 6),
      AddLookupFld('Status', 'Status', '', 'Status', 'Status', 6, [
        {
          Status: 'Active',
        },
        { Status: 'Applicant' },
