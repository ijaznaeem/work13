...
import { AddImage } from '../../../../../../../libs/future-tech-lib/src/lib/components/crud-form/crud-form-helper';
...
export class ContactsComponent implements OnInit {
  ...
  FilterForm = {
    ...
    columns: [
      ...
      AddImage('Image', 'Product Image', 2, false),
        ...
        (event) => {
          this.http
            .openModal(SendsmsComponent, {
              Contacts: GetPhoneNos(this.rptTable.GetSelected(), 'Phone1'),
            })
            .then((r) => {});
        },
        2,
