...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        id: 830,
        path: '/reports/pendingstock',
        title: 'Pending Stock Report',
        icon: 'ft-info submenu-icon',
        class: '',
        badge: '',
        badgeClass: '',
      ...
      {
        id: 840,
        path: '/reports/purchaseexpensereport',
        title: 'Purchase Exepense Report',
        icon: 'ft-info submenu-icon',
        class: '',
        badge: '',
        badgeClass: '',
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        id: 520,
        path: '/accounts/ledger2',
        title: 'Account Ledger 2',
        icon: 'ft-arrow-right submenu-icon',
        class: '',
        badge: '',
        badgeClass: '',
