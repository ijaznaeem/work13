...
import { CustomerAccts2Component } from './customer-accts-protected/customer-accts2.component';
...
const routes:any = [
  ...
  { path: 'ledger2', component: CustomerAccts2Component, data: { breadcrumb: 'Customer Accounts' } },
