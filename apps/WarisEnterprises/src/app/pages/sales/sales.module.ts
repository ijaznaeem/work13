...
const routes :any= [
  ...
  { path: 'cash-sale', component: CashSaleComponent, data: { breadcrumb: 'Stock Transfer' } },
  { path: 'cash-sale/:EditID', component: CashSaleComponent, data: { breadcrumb: 'Stock Transfer' } },
