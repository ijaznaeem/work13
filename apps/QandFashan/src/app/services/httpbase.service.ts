...
import { GetUniqueNo } from "../factories/utilities";
import { environment } from "../../environments/environment";
import { ModalContainerComponent } from "../../../../../libs/future-tech-lib/src/lib/components/modal-container/modal-container.component";
...
export class HttpBase {
  ...
  getProducts(type = '') {
    ...
    return this.getData('products?flds=ProductID,PCode,ProductName,SPrice,PPrice,Packing&' + filter);
  }
  getStock(type :string) {
    const filter = 'filter=Type = ' + type
     
    return this.getData('qrystock?flds=StockID,ProductID,PCode,ProductName,Stock,SPrice,PPrice,Packing&' + filter);
  }
  ...
  GetInvoiceID(){
    return (this.getBusinessID() + (GetUniqueNo().toString()));
  }
  setItem(key, data){
  ...
  getItem(key, def:any={}){
    let val = localStorage.getItem(key) || JSON.stringify ( def);
