...
export class DayBookComponent implements OnInit {
  ...
  FilterData() {
    ...
    if (this.nWhat === '1') {
      ...
      table = "qryinvoices?flds=CustomerName as Description,Sum(Amount) as Amount, Sum(Discount) as Discount, " +
          " Sum(NetAmount) as NetAmount, Sum(CashReceived) as CashReceived, Sum(CreditAmount) as CreditAmount &groupby=CustomerName";
      // filter = filter.replace('IsPosted=0', 'IsPosted=1');
