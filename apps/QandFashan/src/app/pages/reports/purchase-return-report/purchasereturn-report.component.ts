...
@Component({
  selector: 'app-purchasereturn-report',
  templateUrl: './purchasereturn-report.component.html',
  styleUrls: ['./purchasereturn-report.component.scss'],
})
export class PurchaseReturnReportComponent implements OnInit {
  ...
  PrintReport() {
    ...
    this.ps.PrintData.Title = 'purchasereturn Report';
