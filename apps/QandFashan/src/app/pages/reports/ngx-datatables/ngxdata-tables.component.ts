...
import { DatatableData } from '../../../../../../../libs/future-tech-lib/src/lib/components/ngx-datatable/data/users-list.data';
import {
  ColumnMode,
  DatatableComponent,
  SelectionType,
...
@Component({
  selector: 'app-ngxdata-tables',
  templateUrl: './ngxdata-tables.component.html',
})
export class DataTablesComponent implements OnInit {
    ...
    this.http
      .get(
        'https://jsonplaceholder.typicode.com/users?_start=' +
          event.offset * this.page.pageSize +
          '&_limit=' +
          this.page.pageSize
      )
  ...
  MultiPurposeFilterUpdate(event) {
    ...
    // filter our data
    const temp = this.multiPurposeTemp.filter(function (d: any) {
      return d.full_name.toLowerCase().indexOf(val) !== -1 || !val;
    });
