...
const routes:any = [
  ...
  { path: 'bankpayment', component: BankPaymentComponent, data: { breadcrumb: 'Bank Payments' } },
  { path: 'Bankpayment/:EditID', component: BankPaymentComponent, data: { breadcrumb: 'Bank Payments' } },
  ...
  { path: 'bankreceipt/:EditID', component: BankReceiptComponent, data: { breadcrumb: 'Bank Reciepts' } },
