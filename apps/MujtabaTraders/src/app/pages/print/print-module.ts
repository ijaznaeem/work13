...
const routes: any = [
  ...
  {
    path: 'print-gatepass/:invoiceID/:storeID',
    component: PrintGatepassComponent,
    data: { breadcrumb: 'Print' },
  },
  {
    path: 'printinvoice/:id',
    component: CreditInvoiceComponent,
    data: { breadcrumb: 'Print' },
  },
  {
    path: 'printorder/:id',
  ...
  {
    path: 'gatepass/:id/:storeID',
    component: PrintGatepassComponent,
    data: { breadcrumb: 'Print' },
  },
  {
    path: 'printpurchase/:id',
    component: PrintPurchaseComponent,
    data: { breadcrumb: 'Print' },
  },
  {
    path: 'stocktransfer/:id',
    component: PrintStockTransferComponent,
    data: { breadcrumb: 'Print' },
  },
  {
