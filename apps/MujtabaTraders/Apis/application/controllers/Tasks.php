    ...
    private function PostStockTranfer($id = 0, $bid = 0)
    {
        ...
        foreach ($InvoiceRes as $InvoiceValue) {
            ...
            foreach ($InvoiceDetailsRes as $InvoiceDetailsvalue) {
                ...
                $data['Debit']       = 0;
                $data['Description'] = "Stock Transfer # " . $InvoiceValue['TransferID'] ;
                $data['RefID']       = $InvoiceValue['TransferID'];
                $data['RefType']     = 4;
                $data['Notes']       = $InvoiceValue['Notes'];
                $data['BusinessID']  = $InvoiceValue['BusinessID'];
                ...
                if ($PInvoiceValue['DtCr'] == 'CR') {
                    ...
                    foreach ($PInvoiceDetailsRes as $PInvoiceDetailsvalue) {
                        ...
                        $this->UpdateStock(
                            ...
                            $PInvoiceDetailsvalue['PPrice'] + $PInvoiceDetailsvalue['Expense'],
                            0,
                    ...
                    if ($PInvoiceValue['Discount']) {
                        $data['CustomerID']  = $PInvoiceValue['CustomerID'];
                        $data['Date']        = $PInvoiceValue['Date'];
                        $data['Qty']         = 0;
                        $data['Rate']        = 0;
                        $data['Credit']      = 0;
                        $data['Debit']       = $PInvoiceValue['Discount'];
                    ...
                    foreach ($PInvoiceDetailsRes as $PInvoiceDetailsvalue) {
                        ...
                        $data['Credit']      = 0;
                        $data['Description'] = 'Return: ' . $PInvoiceDetailsvalue['ProductName'];
                        $data['RefID']       = $PInvoiceValue['InvoiceID'];
                        $data['RefType']     = 2;
                        $data['Notes']       = $PInvoiceValue['Notes'];
                        $data['BusinessID']  = $PInvoiceValue['BusinessID'];
                    ...
                    if ($PInvoiceValue['Discount']) {
                        ...
                        $data['Rate']        = 0;
                        $data['Debit']       = 0;
                        $data['Credit']      = $PInvoiceValue['Discount'];
                        $data['Description'] = 'Discount';
                        $data['RefID']       = $PInvoiceValue['InvoiceID'];
                        $data['RefType']     = 2;
                        $data['Notes']       = '';
