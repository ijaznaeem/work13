...
@Component({
  selector: 'app-stock-used-report',
  templateUrl: './stock-used-report.component.html',
  styleUrls: ['./stock-used-report.component.scss'],
})
export class StockUsedReportComponent implements OnInit {
  ...
  FilterData() {
    ...
    this.http.getData('qrystockconsumed?filter=' + filter).then((r: any) => {
      this.data = r;
    });
  }
  Clicked(e) {
