 ...
 userName = ''
  constructor(public translate: TranslateService,
    ...
    this.layoutSub = layoutService.toggleSidebar$.subscribe(
      ...
      this.subscription = this.notiService.onNotification().subscribe(message => {
  ...
  ngOnInit() {
    console.log(this.http.getUserData());
    this.userPic =  UPLOADS_URL + "users/" +  this.http.getUserProfilePic();

    this.userName = this.http.getUserData().full_name;
