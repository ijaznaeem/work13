...
const routes: any = [
  ...
  { path: 'product-rates', component: ProductRatesComponent, data: { breadcrumb: 'Manage Product Rates' } },
  { path: 'nationalities', component: NationalityComponent, data: { breadcrumb: 'Manage Nationalities' } },
  ...
  { path: 'cropper', component:CropperComponent, data: { breadcrumb: 'Branches' } },
];
