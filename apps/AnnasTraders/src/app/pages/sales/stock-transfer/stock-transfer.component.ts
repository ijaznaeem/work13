...
import { StockTransfer, TraferDetails } from '../sale.model';
  ...
  public settings = {
    ...
    columns: {
      ProductName: {
        ...
        //   config: {
        //     list: this.Stock, // Pass the custom data source here
        //   },
        // },
        // valuePrepareFunction: (cell) => {
        //   const selectedOption = this.Stock.find(
        //     (item) => item.StockID === cell
        //   );
