...
import { ComboBoxAllModule, ListBoxAllModule } from '@syncfusion/ej2-angular-dropdowns';
...
import { RecoverySheetComponent } from './recovery-report/recovery-sheet.component';
import { SaleLedgerComponent } from './sale-ledger/sale-ledger.component';
import { SaleRecoveryComponent } from './sale-recovery/sale-recovery.component';
...
const routes:any= [
  ...
  { path: 'recoverysheet', component: RecoverySheetComponent, data: { breadcrumb: 'Recovery Sheet' } },
  ...
  { path: 'sale-recovery', component: SaleRecoveryComponent, data: { breadcrumb: 'Sale Recovery' } },
