...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 830, path: '/reports/recoverysheet', title: 'Recovery Sheet', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      ...
      { id: 835, path: '/reports/sale-recovery', title: 'Sale Recovery', icon: 'ft-info submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 720, path: '/settings/smroutes', title: 'Salesman Routes', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      { id: 725, path: '/settings/comp-cats', title: 'Company Categories', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
      ...
      { id: 730, path: '/settings/billing-titles', title: 'Billing Titles', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], },
